...
namespace Magento\SemanticVersionChecker\Operation\RoutesXml;
 ...
 */
class RoutesChanged extends Operation
{
    /**
     * Error codes.
     *
     ...
     * @var string
     */
    protected $reason = 'Routes was changed';
    /**
     ...
     * @param string $target
     */
    public function __construct(string $fileBefore, string $target)
    {
